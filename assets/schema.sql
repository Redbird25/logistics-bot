...
CREATE TABLE IF NOT EXISTS messages (
    ...
    route_from TEXT,
    route_to TEXT,
    route_from_city_id TEXT,
    route_from_city_name TEXT,
    route_from_country TEXT,
    route_from_region TEXT,
    route_to_city_id TEXT,
    route_to_city_name TEXT,
    route_to_country TEXT,
    route_to_region TEXT,
    vehicle_type TEXT,
